...
- No hay capa de analítica/eventos de funnel (`view_product`, `add_to_cart`, `begin_checkout`, `purchase`, `whatsapp_click`); se agregó únicamente captura de `utm_*` en `sessionStorage` (`famores_utm`) como base de atribución.
